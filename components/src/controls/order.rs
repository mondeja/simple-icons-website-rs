    ...
    view! { cx,
        <div class="control">
            ...
            <div class="flex flex-row">
                {move||{
                    // While the `:has` CSS selector is not supported by Firefox,
                    // we need to create the buttons dinamically to correctly style them
                    let mut buttons = vec![
                        view! {cx,
                        ...
                        view! { cx,
                            <ControlButtonSVGPath
                                ...
                                on:click=move |_| set_order_mode(
                                    &OrderModeVariant::Color, &order_mode, &icons_grid, true
                                )
                            />
                        },
                    ];
                        ...
                        buttons.push(
                            view! { cx,
                                <ControlButtonSVGPath
                                    ...
                                    on:click=move |_| set_order_mode(
                                        &OrderModeVariant::SearchMatch, &order_mode, &icons_grid, true
                                    )
                                />
                            }
                        )
