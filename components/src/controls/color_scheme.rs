        ...
        <div class="control">
            ...
            <div>
                <ControlButtonSVGPath
                    ...
                    active=Signal::derive(move || color_scheme() == ColorScheme::Light)
                ...
                <ControlButtonSVGPath
                    ...
                    active=Signal::derive(move || color_scheme() == ColorScheme::Dark)
                ...
                <ControlButtonSVGPath
                    ...
                    active=Signal::derive(move || color_scheme() == ColorScheme::System)
